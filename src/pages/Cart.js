          ...
          const response = await axios.post("http://localhost:5000/api/checkout/payment",{
              ...
              amount:1000},{
                headers: {
                    ...
                    'Authorization': "Bearer pk_test_51KSOH5SJ3Qu163yRvDRSTElNMPWmYuC9HEzkwA9SJmjaRWk0Em0Ij3wRriZI4HhOXreYizpbOHK4iUpRFdvqwaWV00Yho9dDTa"
                },
          })
        ...
        <Bottom>
            <Info>
                ...
                {cart.products.map((product)=> <Product>
                    ...
                    <PrductPrice>Rs {product.price*product.quantity}</PrductPrice>
                    </PriceDetail>
                </Product> )}
                <Hr/>
            ...
            <StripeCheckout name="pretty shop"
